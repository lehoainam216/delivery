        ...
        <ul class="list-unstyled components">
            <li class="active">
                <a href="#dashboard" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i
                        class="fa-solid fa-house yellow_color"></i> <span>Dashboard</span></a>
            ...
            <li><a href="widgets.html"><i class="fa fa-clock orange_color"></i> <span>Widgets</span></a>
            </li>
            <li>
            ...
            <li><a href="charts.html"><i class="fa fa-bar-chart green_color"></i> <span>Charts</span></a>
            </li>
